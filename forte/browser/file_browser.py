...
class FileBrowser(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.proxy_model.enabled = bool(self.settings.get("browser", "fortran_filter"))
    ...
    def _create_new_file(self, dir_path: str):
        ...
        name, ok = QInputDialog.getText(self, "New File", "Filename:", text="untitled.f90")
        if ok and name:
            if not any(name.endswith(e) for e in FORTRAN_EXTENSIONS):
                name += ".f90"
