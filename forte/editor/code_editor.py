# forte/editor/code_editor.py - Code editor widget with line numbers
...
from forte.editor.highlighter import FortranHighlighter
...
class CodeEditor(QPlainTextEdit):
    def __init__(self, parent=None):
        ...
        self.highlighter = FortranHighlighter(self.document(), self._theme)
    ...
    def setup_editor(self) -> None:
        ...
        tab_width = self.settings.get("editor", "tab_width") or 3
