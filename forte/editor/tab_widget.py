# forte/editor/tab_widget.py - Multi-tab editor widget
...
from forte.editor.code_editor import CodeEditor
...
class EditorTabWidget(QTabWidget):
    ...
    def new_file(self) -> CodeEditor:
        """Open a blank editor tab labelled 'untitled.f90'."""
        editor = CodeEditor()
        index = self.addTab(editor, "untitled.f90")
    ...
    def close_tab(self, index: int) -> None:
        ...
        if editor.document().isModified():
            ...
            if reply == QMessageBox.StandardButton.Save:
                ...
                # For now we just discard (Phase 7 will wire this up).
                pass
