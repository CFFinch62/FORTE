# forte/config/settings_dialog.py - Preferences dialog
...
from forte.config.fortran_detector import (
    detect_fortran_compilers, is_valid_compiler,
)
...
class SettingsDialog(QDialog):
    ...
    def _create_build_tab(self):
        ...
        # Compiler group
        compiler_group = QGroupBox("Fortran Compiler")
        ...
        refresh_btn.setToolTip("Re-scan for installed Fortran compilers")
        ...
        self.compiler_path_edit.setPlaceholderText("Path to Fortran compiler executable")
        ...
        self.compiler_flags_edit.setPlaceholderText("-Wall -Wextra -std=f2018")
    ...
    def _refresh_compilers(self):
        ...
        self._detected_compilers = detect_fortran_compilers()
    ...
    def _browse_compiler(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select Fortran Compiler Executable"
        )
        if path:
            self.compiler_path_edit.setText(path)
            self.custom_path_check.setChecked(True)
