# forte/config/themes.py - Dark/Light theme definitions
...
class Theme:
    ...
    background: str
    foreground: str
    keyword: str          # control-flow: if, do, end, program, …
    type_keyword: str     # type specifiers: integer, real, character, …
    intrinsic: str        # built-in functions: abs, sqrt, len, …
    string: str
    comment: str
    number: str
    preprocessor: str     # #include, #define (cpp directives)
    matched_block: str    # DO … END DO / IF … END IF highlight
    error: str
    current_line: str
    selection: str
    line_number_fg: str
